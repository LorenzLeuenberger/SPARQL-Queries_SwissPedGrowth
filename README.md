...
## ⚖️ License & Original SPARQL Queries

> [!IMPORTANT]
> **Credits:** Some SPARQL queries in this repository are adapted from the [SPHN Concept Flattening repository](https://git.dcc.sib.swiss/sphn-semantic-framework/sphn-schema/-/tree/master/quality_assurance/sparql/concept_flattening), 
originally created by the © Personalized Health Informatics (PHI) Group, SIB Swiss Institute of Bioinformatics, under the [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/) license.
